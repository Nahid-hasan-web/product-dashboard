...
const { addProduct, update_Product, update_status, give_review, get_dashboard_product, get_singel_product, deleteProduct } = require('../../controllers/product_controller')
